...
public class QuantityMeasurementDatabaseRepository implements IQuantityMeasurementRepository {
	...
	private static final String SELECT_BY_OPERARION = "SELECT * from quantity_measurement_entity WHERE operation =? ORDER BY created_at DESC";
	...
	private QuantityMeasurementEntity mapResultSetToEntity(ResultSet rs) {
		...
		try {
			QuantityMeasurementEntity entity = new QuantityMeasurementEntity(rs.getDouble("this_value"),
					rs.getString("this_unit"), rs.getString("this_measurement_type"), rs.getDouble("that_value"),
					rs.getString("that_unit"), rs.getString("that_measurement_type"), rs.getString("operation"),
					rs.getDouble("result_value"), rs.getString("result_unit"), rs.getString("result_measurement_type"),
					rs.getString("result_string"), rs.getBoolean("is_error"), rs.getString("error_message"));
			return entity;
